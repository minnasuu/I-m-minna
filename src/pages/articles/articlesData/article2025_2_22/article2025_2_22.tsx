...
export const article2025_2_22= <ArticleLayout>
    <ArticleSectionLayout>
        <ArticlePartLayout>
            ...
            <ArticleDesc>
                <div className={'flex justify-center py-12'}><Animation1/></div>
            </ArticleDesc>
            ...
            <ArticleDesc>下面列举手动重绘的几种方式，实现调整点数与方向、直线转曲线：
                <ul>
                    <li>figma + 插件 fill rule Editor
                        <ArticleImage url={'/articles/articles2025-2-22-2.png'}></ArticleImage>
                    </li>
                    <li>Illustrator</li>
                </ul>
            </ArticleDesc>
