...
fix
  ...
  return (
    <div
      ref={scrollRef}
      className="flex-1 flex items-center gap-20 py-24 bg-gray overflow-auto"
      style={{ height: "240px", flexDirection: "column-reverse" }}
    >
      <div
        className="w-50 bg-gray-3 shrink-0"
        style={{ height: "200px" }}
      ></div>
      <div
        className="relative w-50 overflow-hidden shrink-0"
        style={{ height: open ? `${height + 24}px` : "24px" }}
      >
        <div onClick={handleClick} className="flex items-center cursor-pointer">
          ...
          >
            <path
              d="M6.00004 4.5L8.75 7.25L3.25 7.25L6.00004 4.5Z"
              fill="#33373D"
              fill-opacity="0.58"
            />
          </svg>
        ...
        <div>
          {open
            ? "深度思考的内容...深度思考的内容...深度思考的内容...深度思考的内容...深度思考的内容..."
            : ""}
        </div>
