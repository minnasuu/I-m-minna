...
const SectorWheel: React.FC<SectorWheelProps> = ({
  ...
  return (
    <div
      className={`sector-wheel-container ${className}`}
    ...
    >
      <svg
        ...
        className="article-sector-wheel-svg"
      >
          ...
          {sectors.map((maskSector, maskIndex) => (
            <Fragment key={maskSector.id ?? maskIndex}>
              <mask
                ...
                height={size}
              >
                <path d={maskSector.path} strokeWidth={strokeWidth} />
              </mask>
              <image
                mask={`url(#eqq-home-rotary-circle-icons-white-${
                  maskIndex + 1
                })`}
                href={defaultImgUrl}
                x={strokeWidth}
        ...
        {sectors.map?.((sector, index) => (
          <div
            ...
            style={{
              top: "50%",
              left: "50%",
              height: (circumference * sector.deg) / 360,
              transform: `translate(-50%, -50%) rotate(${
                sector.deg / 2 + sector.startAngle
              }deg)`,
